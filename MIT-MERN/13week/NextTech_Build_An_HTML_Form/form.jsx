...
class ReactIntro extends React.Component {
  /**
   * Function to handle submission of the pizza form. It will grab values from the element IDs, 
   * construct a string, and then both alert that string and add it to the DOM in the most-recent-order div.
